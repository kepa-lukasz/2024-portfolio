        ...
        <div className="w-full" style={{maxWidth : "1900px"}} >
            ...
            <div className="flex mt-2 px-0 px-md-4 mx-1 justify-content-center">
                ...
                <div className="w-full flex flex-wrap justify-center mb-10">
                    ...
                    <StackCard level="0" color="green" icon={<SiTailwindcss size={40}/>} description="Tailwind CSS to nowoczesny framework CSS, umożliwiający szybkie tworzenie niestandardowych stylów poprzez definiowanie klas bezpośrednio w kodzie HTML" name="tailwind&nbsp;css"  />
